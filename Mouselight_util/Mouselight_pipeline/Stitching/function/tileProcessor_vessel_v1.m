function [descriptors,paireddescriptor,curvemodel,scopeparams] = tileProcessor_vessel(scopeloc,descriptorfolder,desc_ch,params)
...
descriptors = getDescriptorsPerFolder_vessel(descriptorfolder,scopeloc,desc_ch);
sprintf('Loaded descriptors')
%% descriptor match:
% 1. Test the running time and memory demand 
% 2. Review the 
...
% Function 
tic;
[paireddescriptor{1},R{1},curvemodel{1}] = fun_xymatch_vessel(descriptors,neighbors(:,checkthese), scopeloc,params);
