function exit_code = fun_task_radius_dependence_anisotropy(task_str)
...
for iter_grid_c = 1 : num_task
    ...
    try 
        exit_code = fun_analysis_compute_radius_dependence_anisotropy(task_str.grid_info, skl_grid_name, grid_c_label, task_str.opt);
