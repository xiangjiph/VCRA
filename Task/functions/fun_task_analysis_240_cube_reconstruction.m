function exit_code = fun_task_analysis_240_cube_reconstruction(task_str)
...
% grid_c_name = task_str.grid_c_name;
...
for iter_grid_c = 1 : num_task
    ...
    try 
        ...
        exit_code = fun_analysis_internal_subgrid(dataset_name, stack, skl_grid_name, grid_c_label, task_str);
