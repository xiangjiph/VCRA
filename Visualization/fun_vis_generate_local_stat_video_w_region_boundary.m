function exit_code = fun_vis_generate_local_stat_video_w_region_boundary(data_array, plot_name, colorbar_name,...
    grid_info, proj_im_str, registration_vis_str, save_im_Q, linear_scaling_factor, ptl_l, ptl_h)
...
%     vis_patch_bbox_xy = ceil(vis_patch_bbox_xy ./ vis_opt.pixel_size);
    ...
    if plot_contour_Q
        ...
        layer_frame = fun_vis_image_with_patch_and_contour(vis_im, patch_value, vis_patch_bbox_xy, ...
            vis_contour_str, vis_opt);
    else
