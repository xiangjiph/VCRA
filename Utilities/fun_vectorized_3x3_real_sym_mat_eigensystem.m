function [eig1, eig2, eig3, v1_1, v1_2, v1_3, v2_1, v2_2, v2_3, v3_1, v3_2, v3_3]...
    = fun_vectorized_3x3_real_sym_mat_eigensystem(A11, A12, A13, A22, A23, A33, autoCorrectionQ)
...
% A13t = A13 ./ p;
% A23t = A23 ./ p;
% eig3 = 0.5 .* ( A11t .* A22t .* A33t + A12t .* A23t .* A13t .* 2 - ...
%     (A13t.^2) .* A22t  - (A12t.^2) .* A33t - (A23t.^2) .* A11t);
% clear A11t A12t A13t A22t A23t A33t
...
A13t = A13 ./ p;
A23t = A23 ./ p;
eig3_t = 0.5 .* ( A11t .* A22t .* A33t + A12t .* A23t .* A13t .* 2 - ...
    (A13t.^2) .* A22t  - (A12t.^2) .* A33t - (A23t.^2) .* A11t);
clear A11t A12t A13t A22t A23t A33t
...
clear p cp_1_2 cp_1_3 cp_2_3 od123 od132 od231 od213 od312 od321 eig1_t eig2_t eig3_t
...
% In current implementation, eig3 has the largest absolute value
% lambda_abs_max = eig3;
thresh_1 = eps(eig3);
...
clear E1_2 E1_22 E1_11 v1_small_angle max_V max_idx tmp_f processed_eig_list1;
% Normalized:
