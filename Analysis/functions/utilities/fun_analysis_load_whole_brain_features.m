...
parfor iter_bbox = 1 : num_load_bbox
    ...
    try
        wb_link_feature_cell{iter_bbox} = tmp_mask_str.link.features;
        wb_node_feature_cell{iter_bbox} = tmp_mask_str.node.features;
        ...
        wb_cube_stat{iter_bbox} = rmfield(tmp_stat_str, {'mask_volume', 'num_surface_voxel'});
    catch ME
