...
if ~isfield(opt, 'skel_recentering_Q')
    ...
    opt.mask2graph.max_rc_int = 40000; % Warning - this value is dataset-dependent. 
end
    ...
    if ~isempty(linker_str)
        ...
        if ~isempty(valid_linker_str)
            ...
            if opt.skel_recentering_Q
                ...
                vessel_skl = fun_skeleton_recentering_within_mask(vessel_skl, rc_metric, vessel_mask_dt > 0);
            end
