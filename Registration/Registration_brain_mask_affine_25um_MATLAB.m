...
target_im_size = round(image_size .* current_voxel_size ./ target_voxel_size);
...
[opt3, metric3] = imregconfig('multimodal');
opt3.MaximumIterations = 1500;
metric3.UseAllPixels = false;
metric3.NumberOfHistogramBins = 50;
metric3.NumberOfSpatialSamples = round(0.01 * numel(im_mov_2));
